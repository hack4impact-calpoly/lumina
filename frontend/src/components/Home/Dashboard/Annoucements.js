...
const Annoucements = ({ setCreateAnnoucement, ...rest }) => {
  return (
    <Box {...rest}>
      <Heading mb={5}>Annoucements</Heading>
      <Center mb={5}>
        <Button variant="animated" bg="red.300" onClick={() => setCreateAnnoucement(true)}>
          + New
        </Button>
      </Center>
      <VStack>
      ...
      <MoreInfo text="See all annoucements"/>
    </Box>
  );
};
